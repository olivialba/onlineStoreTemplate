...
| 1.3 | 07/17/23 | AC added: Requirements, Constraints, Use cases, User Stories, Glossary | [Alima Conde](mailto:aconde4@uncc.edu) | [Alima Conde](mailto:aconde4@uncc.edu) |
...
-**REQ-11:** (AC)
  -**Description:** A function that will allow customers to express their feedback or experience
  -**Type:** Functional
  -**Priority:** 3
  -**Rationale:** Allows customer to share their feelings and experience to improve store quality for the future.
  -**Testing:** Can be tested by implementing survey option where all responses will be stored.
  
-**REQ-12:** (AC)
  -**Description:** A feature that will allow customer to search for a specific item.
  -**Type:** Functional
  -**Priority:** 2
  -**Rationale:** Allows for easy and quick experience for the customer's desires.
  -**Testing:** Can be tested by having multiple search results that are displayed when keywords are written in search bar.
